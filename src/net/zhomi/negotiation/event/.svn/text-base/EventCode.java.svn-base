...
public class EventCode{
	...
	public static final int HTTPPOST_PostGroupImage				= CODE_INC++;
	...
	public static final int HTTPGET_GetGroupByCY				= CODE_INC++;
	...
	public static final int HTTPGET_Register					= CODE_INC++;
	...
	public static final int HP_LoginOut					        = CODE_INC++;
	...
	public static final int IM_Reconnection						= CODE_INC++;
	...
	public static final int LBS_CITY = CODE_INC++;
